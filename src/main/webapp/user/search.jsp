...
<div class="navbar">
  ...
  <a href="uhome.html" style="float: right;"><i class="fa fa-fw fa-sign-in"></i> LogOut</a>
  <a href="contact.html" style="float: right;"><i class="fa fa-fw fa-envelope"></i> ContactUs</a> 
</div>
<table border="1">
	<thead>
<tr>
...
String sql ="select * from bookingdetails where orderno='"+oid+"' ";
...
<td><% out.println(rs.getString("sourceaddress")); %></td>
